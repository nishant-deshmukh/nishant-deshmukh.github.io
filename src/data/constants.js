...
export const projects = [
  {
    ...
    date: "Dec 2023",
    description: "A LinkedIn clone built with React, showcasing a professional networking platform interface. This app features user profiles, posts, and a feed similar to LinkedIn’s, enabling users to explore and interact with content. Integrated with Firebase for backend support and user authentication.",
    image:
      "",
  ...
  },
  {
    ...
    title: "Spotify Clone",
    date: "Feb 2024",
    description: "A Spotify Clone built using React JS, Redux, and Material UI. It features a login page where users can sign in with their Spotify account. The app includes a sidebar with navigation to playlists, albums, and top charts. Users can play, pause, and skip songs with a full-featured music player",
    image:
      "",
